...
API_ID = int(environ.get('API_ID', '23110806'))
API_HASH = environ.get('API_HASH', 'a90a1c01d6f841289e5fa2787e4547bc')
BOT_TOKEN = environ.get('BOT_TOKEN', "7933197755:AAEEuErB7ATr-9C9oBj18gxX2MlqFfhWje0")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8168625630').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002653966830')

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002685681128').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002558133621') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jince847:9C6BBjG6ZnzE2S9x>@cluster0.rai14gg.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "jince847bot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'jincecollection')
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/kin')
